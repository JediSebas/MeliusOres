...
@Mod(MeliusOres.MOD_ID)
public class MeliusOres {

    public static final String MOD_ID = "meliusores";
    ...
    private void enqueueIMC(final InterModEnqueueEvent event) {
        ...
        InterModComms.sendTo(MeliusOres.MOD_ID, "helloworld", () -> { LOGGER.info("Hello world from the MDK"); return "Hello world";});
    }
